...
public class GenerationProject
{
    ...
    private String _entity_Display_Name = String.Empty;
    ...
    public String Entity_Display_Name
    {
        get { return _entity_Display_Name; }
        set { _entity_Display_Name = value; }
    }
    ...
    [Description("Template Configuration Entry.")]
    [Category("Generation Options")]
    ...
    private bool _foreignKeyRelatedCrud;

    [Description("Cretates Foreign Key related Crud Pages When Adding or Editing Detail.")]
    [Category("Generation Options")]
    [DisplayName("Foreign Key CRUD Advanced Mode")]
    public bool ForeignKeyRelatedCrudMode
    {
        get { return _foreignKeyRelatedCrud; }
        set { _foreignKeyRelatedCrud = value; }
    }
