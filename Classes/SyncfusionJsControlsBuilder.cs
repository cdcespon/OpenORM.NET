...
public class SyncfusionJsControlsBuilder : IPlugin
{
    ...
    public class SyncfusionJsCrudBuilder : ITemplate
    {
        ...
        private const string defaultTheme = "default-theme";
        ...
        public SyncfusionJsCrudBuilder(GenerationProject generationProject)
        {
            ...
            TemplateConfigurationEntry defaultThemeEntry = generationProject.TemplateConfigurationEntries.Find(e => e.Template.Equals(TemplateName) && e.Name.Equals(defaultTheme));

            if (defaultThemeEntry == null)
                generationProject.TemplateConfigurationEntries.Add(new TemplateConfigurationEntry(TemplateName, defaultTheme, _defaultTheme));
            else
                _defaultTheme = defaultThemeEntry.Value;
            ...
            try
            {
                ...
                foreach (MyMeta.ITable refTable in db.Tables)
                {
                    ...
                    if (refTable.Selected)
                    {
                        ...
                        output.AppendLine("    <link href=" + System.Convert.ToChar(34) + _resourceUrl + "/Ejs/content/ejthemes/" + _defaultTheme + "/ej.widgets.all.min.css" + System.Convert.ToChar(34) + " rel=" + System.Convert.ToChar(34) + "stylesheet" + System.Convert.ToChar(34) + " />");
                        ...
                        if (generationProject.ForeignKeyRelatedCrudMode){
                            /////////////////////// TABS /////////////////
                            ...
                            output.AppendLine("                            <li class=" + System.Convert.ToChar(34) + "liclass" + System.Convert.ToChar(34) + " style =" + System.Convert.ToChar(34) + "display: none" + System.Convert.ToChar(34) + "><a href=" + System.Convert.ToChar(34) + "#editPanel" + System.Convert.ToChar(34) + ">Detalle de " + tableDesc + "</a></li>");
                        ...
                        foreach (MyMeta.IColumn column in refTable.Columns)
                        {
                            ...
                            {
                                output.AppendLine("            var " + column.Name+ "_ ;");
                                varinit += "            " + column.Name+ "_ = getURLParameter('" + column.Name + "');" + Environment.NewLine;
                                pageparams += column.Name + "=" + System.Convert.ToChar(34) + " + " + column.Name+ "_&";
                                varassign += column.Name+ "_ = args.rowData." + column.Name + ";" + Environment.NewLine;
                        ...
                        if (generationProject.ForeignKeyRelatedCrudMode)
                        {
                            ...
                            output.AppendLine("            loadIFrame(e.activeIndex);");
                            output.AppendLine("        }");
                            output.AppendLine("        function loadIFrame(indice) {");
                            output.AppendLine("            var height = $(window).height();");
                            output.AppendLine("            switch (indice) {");

                            relativepath = db.Name+ "/" + refTable.Schema + "/";
                        ...
                        output.AppendLine("                url: getwebservicesurl() + " + System.Convert.ToChar(34) + relativepath + db.Name+ "." + refTable.Schema + "." + refTable.Name+ ".asmx/items" + System.Convert.ToChar(34) + ",");
                        ...
                        output.AppendLine("                    switch (data.InformationNumber) {");
                        output.AppendLine("                        case 0:");
                        output.AppendLine("                            var resultado = JSON.parse(data.Data);");
                        output.AppendLine("                            loadGrid(resultado);");
                        output.AppendLine("                            break;");
                        output.AppendLine("                        case 1001:");
                        output.AppendLine("                            raiseEventMessageToParent('SessionError', data.Data);");
                        output.AppendLine("                            break;");
                        output.AppendLine("                        default:");
                        output.AppendLine("                            raiseEventMessageToParent('Error', data.Data);");
                        output.AppendLine("                            break;");
                        output.AppendLine("                    }");
                        output.AppendLine("                },");
                        ...
                        output.AppendLine("                }");
                        output.AppendLine("            });");
                        output.AppendLine("            $(" + System.Convert.ToChar(34) + ".liclass" + System.Convert.ToChar(34) + ").css('display', 'block');");


                        output.AppendLine("         hideWaitingImage();");
                        output.AppendLine("");
                        output.AppendLine("        }");
                        foreach (MyMeta.IColumn column in refTable.Columns)
                        {
                            if (column.IsInForeignKey)
                            {
                                foreach (MyMeta.IForeignKey fk in column.ForeignKeys)
                                {
                                    ...
                                    if (!refTable.Name.Equals(fk.PrimaryTable.Name))
                                    {
                                        ...
                                        relativepath = db.Name+ "/" + fk.PrimaryTable.Schema + "/";
                                        output.AppendLine("            $.ajax({");
                                        output.AppendLine("                url: getwebservicesurl() + " + System.Convert.ToChar(34) + relativepath + db.Name+ "." + fk.PrimaryTable.Schema + "." + fk.PrimaryTable.Name+ ".asmx/items" + System.Convert.ToChar(34) + ",");
                                        output.AppendLine("                data: { sessionId: localStorage.getItem(" + System.Convert.ToChar(34) + "session_id" + System.Convert.ToChar(34) + ")},");
                                        output.AppendLine("                type: 'POST',");
                                        output.AppendLine("                dataType: 'json',");
                        ...
                        output.AppendLine("            showWaitingImage(); ");
                        output.AppendLine("            $.ajax({");
                        output.AppendLine("");
                        relativepath = db.Name+ "/" + refTable.Schema + "/";
                        output.AppendLine("                url: getwebservicesurl() + " + System.Convert.ToChar(34) + relativepath + db.Name+ "." + refTable.Schema + "." + refTable.Name+ ".asmx/" + System.Convert.ToChar(34) + " + action,");
                        output.AppendLine("                data: { sessionId: localStorage.getItem(" + System.Convert.ToChar(34) + "session_id" + System.Convert.ToChar(34) + "),");
                        ...
                        output.AppendLine("                 var filters = grid.model.filterSettings.filteredColumns;");
                        output.AppendLine("                 var pager = grid.model.pageSettings.currentPage;");
                        output.AppendLine("             }");
                        output.AppendLine("");
                        ...
                        output.AppendLine("         if (grid != undefined) {");
                        output.AppendLine("             grid.model.filterSettings.filteredColumns = filters;");
                        output.AppendLine("             grid.model.pageSettings.currentPage = pager;");
                ...
                foreach (string schema in schemas)
                {
                    ...
                    foreach (MyMeta.ITable refTable in db.Tables)
                    {
                        if (refTable.Selected && refTable.Schema.Equals(schema))
                        {
                            ...
                            output.AppendLine("                        <li class=" + System.Convert.ToChar(34) + "liclass" + System.Convert.ToChar(34) + " style =" + System.Convert.ToChar(34) + "display: none" + System.Convert.ToChar(34) + "><a href=" + System.Convert.ToChar(34) + "#" + refTable.Name + System.Convert.ToChar(34) + ">" + tableDesc.Replace("_"," ") + "</a></li>");
                                                    }
                    }

                    foreach (MyMeta.IView refView in db.Views)
                    {
                        if (refView.Selected && refView.Schema.Equals(schema))
                        {
                            tableDesc = refView.Name.Equals(String.Empty) ? refView.Description : refView.Name;
                            output.AppendLine("                        <li class=" + System.Convert.ToChar(34) + "liclass" + System.Convert.ToChar(34) + " style =" + System.Convert.ToChar(34) + "display: none" + System.Convert.ToChar(34) + "><a href=" + System.Convert.ToChar(34) + "#" + refView.Name + System.Convert.ToChar(34) + ">" + tableDesc.Replace("_", " ") + "</a></li>");
                        }
                    }
                    ...
                    output.AppendLine("            $(function () {");
                    output.AppendLine("                loadIFrame(0);");
                    output.AppendLine("");
                    ...
                    foreach (MyMeta.ITable refTable in db.Tables)
                    {
                        if (refTable.Selected && refTable.Schema.Equals(schema))
                        {
                            ...
                            output.AppendLine("                    $('#iframe" + tableDesc + "').attr('src', '" + db.Name+ "." + refTable.Schema + "." + tableDesc + ".aspx');");
                    ...
                    relativepath = db.Name+ "/" + schema + "/";

                    SaveOutputToFile(db.Name + "." + schema + ".Crud.aspx", output, relativepath, true);
                }

                ExecuteViewsGridBuilder(db, workingDir, generationProject);
        ...
        private bool ExecuteViewsGridBuilder(MyMeta.IDatabase db, string workingDir, GenerationProject generationProject)
        {
            try
            {
                _workingdir = workingDir;
                ...
                foreach (MyMeta.IView refView in db.Views)
                {
                    ...
                    if (refView.Selected)
                    {
                        ...
                        output.AppendLine("<html xmlns=" + System.Convert.ToChar(34) + "http://www.w3.org/1999/xhtml" + System.Convert.ToChar(34) + ">");
                        output.AppendLine("<head>");
                        output.AppendLine("    <title>ABM de " + refView.Name + "</title>");
                        output.AppendLine("    <meta name=" + System.Convert.ToChar(34) + "viewport" + System.Convert.ToChar(34) + " content=" + System.Convert.ToChar(34) + "width=device-width, initial-scale=1.0" + System.Convert.ToChar(34) + " />");
                        output.AppendLine("    <meta charset=" + System.Convert.ToChar(34) + "utf-8" + System.Convert.ToChar(34) + " />");
                        output.AppendLine("    <link href=" + System.Convert.ToChar(34) + _resourceUrl + "/bootstrap/css/bootstrap.min.css" + System.Convert.ToChar(34) + " rel=" + System.Convert.ToChar(34) + "stylesheet" + System.Convert.ToChar(34) + " />");
                        output.AppendLine("    <link href=" + System.Convert.ToChar(34) + _resourceUrl + "/Ejs/content/ejthemes/" + _defaultTheme + "/ej.widgets.all.min.css" + System.Convert.ToChar(34) + " rel=" + System.Convert.ToChar(34) + "stylesheet" + System.Convert.ToChar(34) + " />");
                        ...
                        output.AppendLine("                    <b>" + refView.Name + "</b>");
                        output.AppendLine("                    <table id=" + System.Convert.ToChar(34) + "templatetable" + System.Convert.ToChar(34) + ">");

                        foreach (MyMeta.IColumn column in refView.Columns)
                        {
                            ...
                            switch (column.LanguageType)
                            {
                                ...
                                case "Bool":
                                    ...
                                    break;
                                default:
                                    if (column.IsInPrimaryKey && !column.IsAutoKey) // EdIView only in Add
                                    {
                                        output.AppendLine("                        <tr>");
                                        output.AppendLine("                            <td style=" + System.Convert.ToChar(34) + "text-align: left;" + System.Convert.ToChar(34) + ">");
                                        output.AppendLine("                                " + fieldDesc);
                                    ...
                                    else if (column.IsAutoKey) // Never edIView 
                                    {
                                        output.AppendLine("                        <tr>");
                                        output.AppendLine("                            <td style=" + System.Convert.ToChar(34) + "text-align: left;" + System.Convert.ToChar(34) + ">");
                                        output.AppendLine("                                " + fieldDesc);
                        ...
                        foreach (MyMeta.IColumn column in refView.Columns)
                        {
                            if (column.IsInForeignKey)// && !column.IsInPrimaryKey)
                                foreach (MyMeta.IForeignKey fk in column.ForeignKeys)
                                {
                                    if (!refView.Name.Equals(fk.PrimaryTable.Name))
                                    {
                                        output.AppendLine("        var fk" + fk.PrimaryTable.Name + "Data;");
                                    }
                                }
                        ...
                        output.AppendLine("            $.ajax({");
                        output.AppendLine("                url: getwebservicesurl() + " + System.Convert.ToChar(34) + relativepath + db.Name+ "." + refView.Schema + "." + refView.Name+ ".asmx/items" + System.Convert.ToChar(34) + ",");
                        output.AppendLine("                data: { sessionId: localStorage.getItem(" + System.Convert.ToChar(34) + "session_id" + System.Convert.ToChar(34) + ")},");
                        output.AppendLine("                type: 'POST',");
                        output.AppendLine("                dataType: 'json',");
                        output.AppendLine("                async: true,");
                        ...
                        relativepath = db.Name+ "/" + refView.Schema + "/";
                        SaveOutputToFile(db.Name + "." + refView.Schema + "." + refView.Name + ".aspx", output, relativepath, true);
                    }
                }
