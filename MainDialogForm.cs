    ...
    public partial class MainDialogForm : Form
    {
        ...
        public void Initialize()
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show("OpenORM.NET must be called as external tool in Visual Studio or SharpDevelop.", "Configuration error", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    Application.Exit();
                }
        ...
        private bool Connect(GenerationProject projectConfig)
        {
            ...
            try
            {
                ...
                if (projectConfig.Entity_Display_Name.Trim().Equals(String.Empty))
                {
                    projectConfig.Entity_Display_Name = "Name";
                }
        ...
        private void PropertyGrid_PropertyValueChanged(object s, PropertyValueChangedEventArgs e)
        {
            ...
            AddOutput("Changed property " + e.ChangedItem.Label  +" from: " + oldValue  + " to: " + e.ChangedItem.Value.ToString(), "", EventObject.EventTypeEnum.WarningEvent);
        }
        ...
        {
            AddOutput("Generated: " + File, "", EventObject.EventTypeEnum.InfoEvent);
        }
